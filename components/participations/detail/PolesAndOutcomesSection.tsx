    ...
    <section className="bg-white pb-24 lg:pb-[120px] px-6 lg:px-10">
      <div className="max-w-[1280px] mx-auto flex flex-col gap-20">
        <div className="flex items-center gap-4">
          ...
          <span className="font-abel text-[#111] text-xl uppercase tracking-tight">Ce que KREST a apporté</span>
        </div>
            ...
            {ALL_POLES.map((pole) => {
              ...
              return (
                <span
                  ...
                  className={
                    active
                      ? "bg-[#f29308]/15 border border-[#f29308] text-[#111] text-base px-4 py-2"
                      : "bg-black/[0.15] border border-dashed border-black/32 text-black/64 text-base px-4 py-2"
                  }
                >
                  {pole}
                </span>
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <div className="flex-1 bg-[#cf2538]/15 border border-[#cf2538] p-6 flex flex-col gap-6">
            ...
            <p className="text-[#111] text-base leading-relaxed whitespace-pre-line">
          ...
          <div className="flex-1 bg-[#f29308]/15 border border-[#f29308] p-6 flex flex-col gap-6">
            <h3 className="font-abel font-bold text-lg uppercase text-[#111]">Résultat</h3>
            <p className="text-[#111] text-base leading-relaxed whitespace-pre-line">
