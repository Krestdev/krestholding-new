    ...
    <section className="bg-white dark:bg-[#0d0d0d] py-24 lg:py-[120px] px-6 lg:px-10">
      <div className="max-w-[1280px] mx-auto flex flex-col gap-14">
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-20">
          ...
          <p className="text-black dark:text-white text-2xl sm:text-4xl leading-tight lg:flex-1">
        ...
        <div className="flex flex-wrap items-end justify-end gap-x-6 gap-y-8 border-t border-black/16 dark:border-white/16 pt-6">
          {stats.map((stat, idx) => (
