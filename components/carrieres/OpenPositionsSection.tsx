            ...
            {pageItems.map((job) => {
              ...
              return (
                <Link
                  ...
                  className="border border-black/10 p-6 flex flex-col gap-6 transition-colors hover:border-black/30"
                >
                  {published && (
                    <span className="text-black/40 text-[10px] uppercase tracking-wide">Publiée le {published}</span>
                  )}
