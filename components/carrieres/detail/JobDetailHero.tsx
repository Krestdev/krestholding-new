    ...
    <section className="relative flex flex-col items-center px-6 lg:px-10 pt-[120px] pb-10 bg-gradient-to-b from-[rgba(13,13,13,0.8)] to-[#0d0d0d]">
      <div className="w-full max-w-[1280px] flex flex-col gap-10">
        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-10">
          <div className="flex flex-col gap-6 max-w-[624px]">
            ...
            <div className="flex flex-wrap gap-4 pt-2">
              <a
                ...
                className="inline-flex items-center gap-2.5 pl-6 pr-3.5 py-3 bg-[#f29308] text-black font-mono text-sm uppercase tracking-wide transition-colors hover:bg-[#f29308]/85"
              >
                <span>Postuler</span>
                <CtaArrow size={18} />
              </a>
          ...
          <div className="bg-white w-full lg:w-[360px] shrink-0 flex flex-col">
            <div className="border-b border-black/10 p-4">
              <span className="font-abel text-black text-xs uppercase tracking-wide">Résumé</span>
            </div>
            {[
              ["Entité", entity?.name || "—"],
              ...
              <div
                key={label}
                className={`flex items-center justify-between gap-4 px-4 py-3 ${idx % 2 === 0 ? "bg-black/[0.03]" : ""}`}
              >
                <span className="text-black/64 text-sm">{label}</span>
